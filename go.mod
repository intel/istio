...
// bindings
replace github.com/envoyproxy/go-control-plane => github.com/intel/envoy-go-control-plane v0.10.3-0.20230615020718-65f57a32704f

replace istio.io/api => github.com/intel/istio-api v0.0.0-20230615053609-3e0844ba66e1
